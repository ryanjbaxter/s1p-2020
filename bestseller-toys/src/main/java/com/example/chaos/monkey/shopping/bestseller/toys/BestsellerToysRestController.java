...
public class BestsellerToysRestController {
	...
	public List<Product> getBestsellerProducts() {
		...
		Product product1 = productBuilder.setCategory(ProductCategory.TOYS).setId(aLong.getAndIncrement())
		...
		Product product3 = productBuilder.setCategory(ProductCategory.TOYS).setId(aLong.getAndIncrement())
